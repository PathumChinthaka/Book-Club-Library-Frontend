...
const AddBookForm: React.FC<AddBookFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(`${isUpdateMode ? "Book updated" : "Book added"} successfully!`);
    } catch (error) {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 rounded-sm bg-black/30 backdrop-blur-sm">
      <div
        className={`bg-white w-full max-w-lg rounded-xl shadow-lg p-6 transform transition-all duration-300 ${
